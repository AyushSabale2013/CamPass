  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex items-center justify-between bg-white p-3 rounded-xl border border-slate-200 shadow-sm">
        <div>
          <h2 className="text-sm font-extrabold text-slate-900">Bus Exits</h2>
      ...
      {/* Bus Exits — Total Count for Selected Date */}
      <div className="bg-white p-3.5 rounded-2xl border border-slate-200 shadow-sm flex items-center gap-3">
        ...
        <div className="min-w-0">
          <span className="block text-[10px] uppercase font-bold text-slate-400 tracking-wider">
            Bus Exits {formattedBusDate ? `— ${formattedBusDate}` : ""}
          </span>
        ...
        <div className="flex items-center justify-between bg-slate-50 p-2.5 rounded-xl border border-slate-200 gap-2">
          ...
          {isCustomDate && (
            <button
              ...
              className="text-[10px] font-black text-rose-700 bg-rose-50 border border-rose-200 px-2.5 py-1.5 rounded-lg whitespace-nowrap hover:bg-rose-100 transition"
            >
              Today
            </button>
          )}
