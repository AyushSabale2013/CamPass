...
const DayscholarsInsideView = ({ logs, fetching, setView }) => {
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex items-center justify-between bg-white p-3 rounded-xl border border-slate-200 shadow-sm">
        <div>
          <h2 className="text-sm font-extrabold text-slate-900">Day Scholars Inside Campus (Today)</h2>
...
export default DayscholarsInsideView;